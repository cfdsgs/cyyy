...
int main(int argc, char *argv[])
{
	...
	int op = atoi(argv[2]);      	// declare the table size and initialize its value
	...
	DWORD m =::GetTickCount();     //Get the number of milliseconds
	...
	DWORD e=::GetTickCount();     //Get the number of milliseconds 　　
	int se = e-m;     // se represent millisecond 　　
	cout<<"The total time consuming��"<<se<<"millisecond"<<endl;
	fin.close();
